%--------------------------------------------------------------------------
% Program MA_05_sefade.m: generates frequency selecting fading
%--------------------------------------------------------------------------

function[iout,qout,ramp,rcos,rsin] = MA_05_sefade(idata,qdata,itau,dlvl,th,n0,itn,n1,nsamp,tstp,fd,flat)
...
for k = 1 : n1 
	...
	[itmp,qtmp]                     = MA_05_delay ( idata , qdata , nsamp , itau(k));
	[itmp3,qtmp3,ramp,rcos,rsin]    = MA_05_fade (itmp,qtmp,nsamp,tstp,fd,n0(k),itn(k),flat);
