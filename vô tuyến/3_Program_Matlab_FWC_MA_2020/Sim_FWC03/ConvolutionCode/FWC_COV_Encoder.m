function output = FWC_COV_Encoder(g,k0,input)
...
% % iput    = input('Nhap chuoi bit thong tin vao bo ma hoa=  ');
% 
...
% 
% %==============================
% % kiem tra kich thuoc Matran G.
% %==============================
% if rem(size(g,2),k0)>0
%    error('loi, kich thuoc G la sai ');   
% end
% 
% 
% %=====================
...
% 
% %========================================================
% % tao uu, ma tran ma cac cot cua no la noi dung cua conv
% % bo ma hoa tai cac Cky clock khac nhau.
% %========================================================
% 
% u1          =   u(l*k0:-1:1);
% 
