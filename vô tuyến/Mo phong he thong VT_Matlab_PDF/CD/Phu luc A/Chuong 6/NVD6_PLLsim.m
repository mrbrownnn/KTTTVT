...
G   =   2*pi*fn*(zeta1+sqrt(zeta1*zeta1-lambda));	% set loop gain
a   =   2*pi*fn/(zeta1+sqrt(zeta1*zeta1-lambda));	% set filter parameter Note zeta1
