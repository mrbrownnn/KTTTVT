...
xlabel('LÆp [lÇn] ','fontname','.Vntime','fontsize',12);
ylabel('X¸c suÊt','fontname','.Vntime','fontsize',12);
title('Kh¶o s¸t tÝnh héi tô cña ph©n bè x¸c su©t tr¹ng th¸i ®Õn c¸c gi¸ trÞ tr¹ng th¸i bÒn v÷ng','fontname','.Vntime','color','b','fontsize',12)
