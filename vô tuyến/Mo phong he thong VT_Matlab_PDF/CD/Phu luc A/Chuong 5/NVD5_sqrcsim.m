...
title('§¸p øng xung kim cña bé läc sè: p[n-1]','fontname','.Vntime','color','b','fontsize',12);
...
title('Tæng chËp cña ®¸p øng xung kim bé läc sè: conv(p[n-1],p[n])','fontname','.Vntime','color','b','fontsize',12);