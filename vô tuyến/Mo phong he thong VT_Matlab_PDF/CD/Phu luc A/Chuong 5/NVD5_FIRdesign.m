...
title(['§¸p øng xung kim: Tæng sè mÉu =',num2str(2*L+1),...
    '; DÞch L = ',num2str(L),' mÉu'],'fontname','.Vntime','color','b','fontsize',14);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('ChØ sè mÉu','fontname','.Vntime','fontsize',12);
ylabel('§¸p øng xung kim','fontname','.Vntime','fontsize',12);
title('§¸p øng xung kim kh«ng ®­îc cöa sæ:','fontname','.Vntime','color','b','fontsize',14)
subplot(2,1,2);
stem(wbp_w,'.');
xlabel('ChØ sè mÉu','fontname','.Vntime','fontsize',12);
ylabel('§¸p øng xung kim','fontname','.Vntime','fontsize',12);
title('§¸p øng xung kim:','fontname','.Vntime','color','b','fontsize',14);