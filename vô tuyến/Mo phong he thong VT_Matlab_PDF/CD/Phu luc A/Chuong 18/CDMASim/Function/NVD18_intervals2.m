...
xlabel('Chuçi gèc - ChiÒu dµi c¸c kho¶ng m','fontname','.Vntime','color','b','fontsize',12);
...
grid;
ylabel('Pr(0m|1)','fontname','.Vntime','color','b','fontsize',14);
xlabel('Chuçi ®­îc t¸i t¹o - ChiÒu dµi c¸c kho¶ng  m','fontname','.Vntime','color','b','fontsize',12);