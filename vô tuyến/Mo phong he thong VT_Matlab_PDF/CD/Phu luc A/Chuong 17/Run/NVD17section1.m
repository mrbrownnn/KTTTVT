...
%%% Section 7
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SIR_fwd_2(i) = normrand(m_SIR_fwd(i),sigma_SIR_fwd(i));
SIR_rev_2(i) = normrand(m_SIR_rev(i),sigma_SIR_rev(i))
...
des_sig_spl_rev         = normrand(m_S_rev,sigma_S);
int_sig_spl_rev         = normrand(m_I_rev,sigma_U_rev);
