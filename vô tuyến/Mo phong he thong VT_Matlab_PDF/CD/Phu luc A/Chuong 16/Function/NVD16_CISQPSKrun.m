function BER_CIS=NVD16_CISQPSKrun(N,Eb,No,ChanAtt,...
	TimingBias,TimingJitter,PhaseBias,PhaseJitter,CISBias)

% file: NVD16_CISQPSKrun.m
...
%=====================================================
[unused,SourceBitsI] = NVD16_random_binary(SymToSend,1);
[unused,SourceBitsQ] = NVD16_random_binary(SymToSend,1);
%===========================================
...
while TxSymSent < SymToSend
   ...
   %---------------------------------------------------
   CISWeight = NVD16_cgpdf(BiasedNoise,0,RxNoiseStd)./NVD16_cgpdf(BiasedNoise,0,CISBias*RxNoiseStd);
   %--------------------------------------------------
...
%===============================
[C,Lags]        = NVD16_vxcorr(SourceBitsI(10:110),SinkBitsI(10:110));
[MaxC,LocMaxC]  = max(C);
