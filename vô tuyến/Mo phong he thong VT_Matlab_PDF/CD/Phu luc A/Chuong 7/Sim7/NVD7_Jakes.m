...
title('§¸p øng xung kim vµ PSD','fontname','.vntime','color','b','fontsize',12)
...
subplot(2,1,2)
plot(f,abs(h.*h));
xlabel('TÇn sè','fontname','.vntime','fontsize',12);
...
xlabel('TÇn sè','fontname','.vntime','fontsize',12); 
ylabel('PSD','fontname','.vntime','fontsize',15);
title('PSD vµ §­êng bao ®­îc ­íc tÝnh','fontname','.vntime','color','b','fontsize',12)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
axis([0.1 0.3 -20 0])
xlabel('Thêi gian','fontname','.vntime','fontsize',12);
ylabel('Log biªn ®é','fontname','.vntime','fontsize',12);
grid;