...
title(['Chuçi PN: sè mÉu trªn ký hiÖu lµ = ',num2str(samp_per_sym),...
    ';  Chu chu kú = ',num2str(n,15)],'fontname','.vntime','color','b','fontsize',12);

subplot(3,1,2)
stem(x2,Rm(1:101),'.k');
ylabel('R[m] mét phÇn','fontname','.vntime','color','b','fontsize',10);

subplot(3,1,3)
stem(x2,pndata(1:101),'.k');
ylabel('100 ®Çu ra ®Çu tiªn','fontname','.vntime','fontsize',10);
axis([0 100 -1.5 1.5]);