...
ylabel('§¸p øng biªn ®é','fontname','.Vntime','fontsize',12);
title('T¹o t¹p ©m flicker khi bËc bé läc =3','fontname','.vntime','color','b','fontsize',14);
legend('Ham truyen dat mong muon','Ham truyen dat mo phong')
subplot(2,1,2)
plot(F,M,':',w2/pi,abs(h2));
xlabel('TÇn sè chuÈn hãa','fontname','.Vntime','fontsize',12);
ylabel('§¸p øng biªn ®é','fontname','.Vntime','fontsize',12);
title('T¹o t¹p ©m flicker khi bËc bé läc = 20','fontname','.vntime','color','b','fontsize',14);
legend('Ham truyen dat mong muon','Ham truyen dat mo phong')