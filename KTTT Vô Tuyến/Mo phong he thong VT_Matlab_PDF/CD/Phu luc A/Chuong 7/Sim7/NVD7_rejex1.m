...
ylabel('Sè mÉu','fontname','.vntime','fontsize',12)
xlabel('BiÕn ®éc lËp - x','fontname','.vntime','fontsize',12);
title(['Ph­¬ng ph¸p lo¹i bá: Sè ®iÓm ®­îc chÊp nhËn = ',num2str(kpts,15),...
    ';  vµ N = ',num2str(N,15)],'fontname','.vntime','color','b','fontsize',12);
subplot(2,1,2)
...
ylabel('MËt ®é x¸c suÊt','fontname','.vntime','fontsize',12)
xlabel('BiÕn ®éc lËp - x','fontname','.vntime','fontsize',12)
