function [h,times] = NVD5_Filter_AMP_Delay (H,fs,n,fscale,fshift,dscale)
...
% If the lower end does not extend to -fs/2 add a point
if fmin < Hfreq(1,1)
    Hfreq1  = [fmin;Hfreq];
    Hreal1  = [1e-10;Hreal] ; 
...
% If the higher end does not extend to fs/2 add a point
if  fmax > Hfreq(nn,1)
    Hfreq1  = [Hfreq1; fmax];
    Hreal1  = [Hreal1;1e-10] ; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Interpolate the frequency response data and 
% compute the complex transfer function mag*exp(i*phase)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
