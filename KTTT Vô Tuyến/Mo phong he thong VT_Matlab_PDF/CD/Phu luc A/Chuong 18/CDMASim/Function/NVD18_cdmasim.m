function [BER,ErrorRun] =   NVD18_cdmasim(N,SF,EbNo,NumInterferers,MPathDelay,Kfactor_dB)
% file NVD18_cdmasim.m: Simulation for CDMA System
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% filter parameters & 4th order fitler
FilterOrder     = 4;
Ripple          = 0.5;
BW              = 0.01;
...
DesiredSequence     = NVD18_MSequence(SF+1);          % desired signal
