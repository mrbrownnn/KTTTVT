...
%           XX=FSERIES(FUNCFCN,A,B,N,TOL,P1,P2,P3)
%			funfcn = The given function, in an m-file.
% 			It can depend on up to three parameters p1, p2 and p3. The function 
%			is given over one period extending from 'a' to 'b'
%			xx = vector of length n+1 of Fourier series coefficients, xx0,xx1....xxn.
