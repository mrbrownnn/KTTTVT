...
% water-Filling allocation algorithm (Eq: 9.25) for solution to the optimization problem (Eq9.25)
% Note that more power must be allocated to the mode with higher SNR. 
% if an SNR is below the threshold given in terms m, 
% the corresponding modes must not be used, that is, no power allocated to them.
